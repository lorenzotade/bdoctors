            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        {{-- STREET --}}
                        <div class="form-group row">
                            <label for="street" class="col-md-4 col-form-label text-md-right">{{ __('Indirizzo') }}</label>
                        ...
                        {{-- POSTAL CODE --}}
                        <div class="form-group row">
                            <label for="postal_code" class="col-md-4 col-form-label text-md-right">{{ __('CAP') }}</label>

                            <div class="col-md-6">
                                <input id="postal_code" type="text" class="form-control @error('postal_code') is-invalid @enderror" name="postal_code" value="{{ old('postal_code') }}" required autocomplete="name" autofocus>
                        ...
                        {{-- GENDER --}}
                        <div class="form-group row">
                            <label class="label-control" for="gender">Genere</label>
                            <select class="form-control mb-3" name="gender" id="gender">
                                <option class="" value="">Seleziona maschio o femmina</option>
                                <option name="gender" value="0" @if(old('gender')) selected @endif>Maschio</option>  
                                <option name="gender" value="1" @if(old('gender')) selected @endif>Femmina</option>
                            </select>
